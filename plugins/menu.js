 ...
 *Powered By @${'6283120494967'.split('@')[0]}*`
 ...
   "productImage":{ 
   "mimetype": "image/jpeg", 
   "jpegThumbnail": await (await fetch('https://telegra.ph/file/eb9553095e8638793956d.jpg')).buffer(), //Gambarnye
     }, 
   "title": `${ucapan()}`, 
 ...
 const fload = {
    ...
    orderTitle: `▮Menu ▸`,
    thumbnail: await (await fetch('https://telegra.ph/file/aab35c34e73a8bdf35752.jpg')).buffer(), //Gambarnye
...
Saya Adalah YuuKiBotzy Salah Satu Bot Whatsapp Yang Siap Membantu Kamu Mempermudah Sesuatu Seperti Membuat Sticker Dan Lainnya, Kalo Kamu Mau Request Fitur Silahkan Ketik #request Pesan Atau Fitur Yang Kamu Inginkan!`
