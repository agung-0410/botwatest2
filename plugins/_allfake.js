...
handler.all = async function (m) {
	...
	try {
	 ...
	 { remoteJid: "6283120494967-1625305606@g.us" } : {}) 
                },
	 message: { 
		"audioMessage": {
...
key: {
			fromMe: false,
			participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6283120494967@s.whatsapp.net" } : {})
		},
		message: {
			"productMessage": {
				"product": {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "6283120494967-1625305606@g.us",
			"inviteCode": "null",
