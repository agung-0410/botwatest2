...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.img = 'https://telegra.ph/file/bfd6a04700bc4b9a0d2e3.png'
        global.fla = pickRandom(global.flaaa)
        global.namabot = conn.user.name
        global.packname = '@YuuKibotz'
        global.author = 'Made By Yu'
        global.packname2 = 'Made With'
        global.author2 = 'YuukiBotz By Yui'
        global.wm3 = 'Yu'
        global.wm2 = 'Yu' + ' ' + 'By Yu'
        global.wm = 'YuuKi'
        global.colong1 = 'Yui��'
        global.colong2 = 'YuuKibotz'
        global.kontak2 = [
        ['16199961931', 'Ziv San', 'Creator Bot', 'Zivsan@support.com', true],
        ['6282179137771', 'CUTE IQ-MD', 'Bot WhatsApp', 'Just Bot', true]
        ['6283120494967', 'YuuKiBotz', 'For�', 'Just Bot', true]
        ]
...
global.thumb = 'https://telegra.ph/file/bfd6a04700bc4b9a0d2e3.png'
